...
export function DashboardPreview() {
 ...
 <div className="h-6 w-6 radius-md bg-white/50 dark:bg-white/10 flex items-center justify-center border-border-subtle">
 ...
 <div className="hidden lg:flex items-center gap-space-2 bg-white/40 dark:bg-black/40 border-border-subtle radius-md px-space-4 py-space-1.5 text-caption text-muted-foreground w-56 group hover:bg-white/60 dark:hover:bg-black/60 transition-colors">
 ...
 <span className="text-caption font-mono leading-none bg-black/5 dark:bg-white/10 px-space-1.5 py-space-1 radius-md border-border-subtle shrink-0 text-foreground/70">
 ⌘K
 </span>
 </div>
 </div>
 ...
 <span className="relative text-caption font-semibold radius-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30 px-space-3.5 py-space-1.5 flex items-center gap-space-2 backdrop-blur-md">
 ...
 <div className="relative p-space-5 flex flex-col justify-between radius-2xl border-border-default bg-white dark:bg-card shadow-sm transition-all duration-300 hover:-translate-y-space-0.5 hover:shadow-md">
 <div className="flex justify-between items-start">
 <span className="text-caption font-semibold text-muted-foreground uppercase tracking-widest">
 {stat.label}
 </span>
 <span className="text-caption font-semibold px-space-2 py-space-0.5 radius-md bg-primary/10 text-primary border-primary/20">
 {stat.change}
 </span>
 </div>
 ...
 <div
 className={`flex-1 radius-2xl border-white/20 dark:border-white/10 bg-white/70 dark:bg-black/50 backdrop-blur-xl flex flex-col overflow-hidden min-w-0 relative ${
 ...
 <Button className="h-9 w-9 p-space-0 radius-md border-border-default bg-white/50 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 text-muted-foreground hover:text-foreground transition-all">
 ...
 <div className="radius-2xl border-white/20 dark:border-white/10 bg-white/50 dark:bg-black/60 p-space-5 relative overflow-hidden group">
 ...
 className="h-12 w-12 radius-md bg-gradient-to-br from-primary to-indigo-600 text-white flex items-center justify-center hover:scale-105 transition-all 0_0_20px_rgba(99,102,241,0.4)] shrink-0 active:scale-95 border-white/20"
 >
 {isPlaying ? (
 ...
 <div className="relative border-l border-border-default pl-space-7 ml-space-4 space-y-space-7">
 {selectedCall.timeline.map((step, idx) => (
 <div key={idx} className="relative group/step">
 {/* Animated Glowing Node */}
 <div className="absolute -left-[37px] top-space-0 h-7 w-7 radius-md bg-white dark:bg-gray-900 border-border-default group-hover/step:border-primary transition-colors flex items-center justify-center text-primary shrink-0 z-10">
 {step.active && (
 ...
 <div className="min-w-0 pl-space-1 bg-white/40 dark:bg-white/5 radius-xl p-space-3 border-transparent group-hover/step:border-white/20 dark:group-hover/step:border-white/10 transition-colors">
 ...
 <div className="space-y-space-5 bg-white/30 dark:bg-black/20 border-white/20 dark:border-white/5 radius-3xl p-space-5 relative">
 ...
 bubble.speaker === "ai"
 ? "bg-gradient-to-br from-primary/10 to-indigo-500/10 dark:from-primary/20 dark:to-indigo-500/20 text-foreground border-primary/20 radius-bl-sm"
 : "bg-white/80 dark:bg-white/10 text-foreground border-border-default radius-br-sm"
 }`}
 >
 {bubble.text}
 </div>
 ...
 <div
 key={idx}
 className="flex items-center gap-space-2 shrink-0 whitespace-nowrap bg-white/80 dark:bg-white/10 border-border-default px-space-3 py-space-1.5 radius-md hover:scale-105 transition-transform cursor-default"
 >
 <div className="h-4 w-4 radius-md bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border-emerald-500/30 flex items-center justify-center shrink-0 0_0_8px_rgba(16,185,129,0.3)]">
 ...
 <div
 key={chat.id}
 className="radius-2xl border-white/20 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-md p-space-5 flex flex-col sm:flex-row sm:items-center justify-between hover:border-primary/30 0_8px_30px_rgba(99,102,241,0.12)] hover:-translate-y-space-0.5 transition-all duration-300 gap-space-4"
 style={{ animationDelay: `${idx * 100}ms` }}
 >
 <div className="flex items-center gap-space-5">
 <div className="h-12 w-12 radius-2xl bg-gradient-to-br from-primary/10 to-indigo-500/10 border-primary/20 text-primary flex items-center justify-center shrink-0">
 ...
 <span className="text-caption radius-md bg-white/80 dark:bg-white/10 border-border-default px-space-2.5 py-space-0.5 text-muted-foreground font-semibold tracking-widest uppercase">
 {chat.source}
 </span>
 </div>
 ...
 <span className="text-caption font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/15 border-emerald-500/30 px-space-3 py-space-1.5 radius-md uppercase tracking-wider">
 {chat.status}
 </span>
 ...
 <span className="text-caption font-semibold text-foreground bg-white/80 dark:bg-white/10 border-border-default px-space-4 py-space-2 radius-xl font-mono self-start sm:self-auto backdrop-blur-md">
 Friday, July 9, 2026
 </span>
 </div>
 ...
 <div
 key={i}
 className="flex flex-col sm:flex-row sm:items-center justify-between radius-2xl border-white/20 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-md px-space-6 py-space-4 hover:border-primary/30 transition-all duration-300 gap-space-4 group"
 >
 <div className="flex items-center gap-space-5">
 ...
 <span className="text-caption font-semibold uppercase tracking-widest text-primary bg-primary/10 border-primary/20 px-space-3.5 py-space-1.5 radius-md shrink-0 self-start sm:self-auto">
 {slot.status}
 </span>
 </div>
 ))}
 ...
 <span className="text-caption font-semibold text-muted-foreground uppercase tracking-widest font-mono bg-white/80 dark:bg-white/10 border-border-default px-space-4 py-space-2 radius-xl backdrop-blur-md">
 July 2026 REPORT
 </span>
 </div>
 ...
 <div
 key={i}
 className="radius-2xl border-white/20 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-md p-space-6 hover:border-primary/40 hover:-translate-y-space-1 0_15px_30px_rgba(99,102,241,0.15)] transition-all duration-300 text-center relative overflow-hidden group"
 >
 ...
 <div className="radius-2xl border-white/20 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-md p-space-6 space-y-space-6 relative group mt-space-2">
 ...
 <span className="text-caption font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/15 border-emerald-500/30 px-space-3 py-space-1.5 radius-md flex items-center gap-space-1.5 uppercase tracking-wider">
