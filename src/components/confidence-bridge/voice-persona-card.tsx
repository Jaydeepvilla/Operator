...
export function VoicePersonaCard({ businessName }: VoicePersonaCardProps) {
 ...
 return (
 <div className="relative overflow-hidden rounded-xl border-border/80 bg-card/70 backdrop-blur-md p-4 sm:p-5 shadow-sm space-y-4 transition-all">
 {/* Header */}
 ...
 <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 px-2 py-0.5 text-[11px] font-semibold text-emerald-500 border-emerald-500/20 whitespace-nowrap">
 ...
 <div className="rounded-lg border-border/70 bg-background/90 p-3 space-y-2">
 ...
 <p className="text-xs text-foreground/90 font-medium leading-relaxed italic border-l border-primary/50 pl-2.5">
 "{currentGreeting}"
        </p>
      </div>
    </div>
