...
function ScreenUrl({
 ...
 <div className="inline-flex items-center gap-space-2 px-space-3 py-space-1 rounded-full border-primary/20 bg-primary/5">
 ...
 {/* Stats */}
 <div className="grid grid-cols-3 gap-space-3 p-space-4 rounded-xl border-border/50 bg-muted/20">
...
function ScreenGenerating({
 ...
 {/* Progress console */}
 <div className="rounded-xl border-border bg-muted/30 overflow-hidden">
...
function ScreenVerify({
 ...
 <div className="flex items-center gap-space-1.5 px-space-2.5 py-space-1 rounded-full bg-emerald-500/10 border-emerald-500/20 shrink-0">
 ...
 {/* Info callout */}
 <div className="flex items-start gap-space-3 px-space-4 py-space-3 rounded-xl border-primary/20 bg-primary/5">
 ...
 {/* Tab navigation */}
 <div className="flex p-1 rounded-xl bg-muted/40 border-border/40">
 {tabs.map((t) => {
 const TIcon = t.icon;
 return (
 <button
 ...
 activeTab === t.id
 ? "bg-card text-foreground shadow-sm font-semibold border-border/50"
 ...
 >
 <span className="flex h-5 w-5 items-center justify-center rounded-full border-primary/40 text-caption font-semibold">+</span>
 ...
 {activeTab === "greeting" && (
 <div className="space-y-space-4 animate-fade-up" style={{ animationFillMode: "both" }}>
 <div className="flex items-start gap-space-3 px-space-4 py-space-4 rounded-xl border-border/80 bg-muted/20">
 ...
 rows={4}
 className={cn(
 "w-full rounded-xl border-border/80 bg-background px-space-4 py-space-3",
...
function ScreenLaunching() {
 ...
 <div className="absolute h-28 w-28 rounded-full border-primary/20 animate-ping [animation-duration:2.5s]" />
...
export function OnboardingWizard({
 ...
 {submitError && (
 <div className="flex items-start gap-space-3 px-space-4 py-space-3 rounded-xl border-destructive/20 bg-destructive/5 mb-space-6">
