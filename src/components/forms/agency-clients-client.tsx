...
export function AgencyClientsClient({ initialClients }: { initialClients: any[] }) {
 ...
 {/* Controls Bar */}
 <div className="flex flex-col gap-space-4 sm:flex-row sm:items-center sm:justify-between bg-card/20 p-space-4 radius-lg border-border/50 backdrop-blur-xs">
 ...
 <div className="flex items-center gap-space-3">
 <div className="flex h-10 w-10 items-center justify-center radius-lg bg-primary/10 text-primary border-primary/20">
 ...
 <div className="col-span-full py-space-12 text-center text-muted-foreground bg-card/20 radius-xl border-border/80">
