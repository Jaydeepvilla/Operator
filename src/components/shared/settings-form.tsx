...
export function PersonalSettingsForm({ initialData }: SettingsFormProps) {
 ...
 <div className="bg-card border-[hsl(var(--foreground)/0.06)] rounded-2xl p-6 sm:p-8 shadow-sm relative min-h-[400px] w-full">
 {errorMsg && (
 <div role="alert" className="flex items-center gap-3 bg-rose-500/10 border-rose-500/20 text-rose-200 p-4 rounded-xl text-caption animate-fade-in mb-6">
 ...
 <div className="relative group w-20 h-20 rounded-full bg-primary/10 border-primary/20 flex items-center justify-center overflow-hidden shrink-0 text-xl text-primary font-bold uppercase transition-all duration-300 shadow-md">
 {avatar ? (
 ...
 className="px-4 py-2 text-xs font-semibold rounded-full bg-black text-white hover:bg-zinc-900 border-zinc-800 transition-colors shadow-sm cursor-pointer inline-flex items-center justify-center gap-1.5"
 >
 Upload Image
 </label>
 <input
 ...
 className="px-4 py-2 text-xs font-semibold rounded-full bg-muted text-muted-foreground hover:text-foreground hover:bg-muted/95 border-[hsl(var(--foreground)/0.06)] transition-all cursor-pointer inline-flex items-center justify-center"
 >
 Remove
 </button>
 )}
 ...
 className="w-full min-h-[100px] bg-[hsl(var(--foreground)/0.02)] border-border/80 focus:border-primary/50 focus:ring-2 focus:ring-primary/10 rounded-xl px-4.5 py-3 text-body-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-all duration-200"
 />
 </div>
 ...
 <div className="flex items-start gap-3 bg-[hsl(var(--foreground)/0.02)] border-border/40 p-4 rounded-xl">
 <input
 id="notify-email"
 type="checkbox"
 checked={emailNotify}
 ...
 {passwordSuccess && (
 <div className="flex items-center gap-2 bg-emerald-500/10 border-emerald-500/20 text-emerald-200 p-4 rounded-xl text-caption animate-fade-in">
 ...
 placeholder="••••••••"
 className="w-full bg-[hsl(var(--foreground)/0.02)] border-border/80 focus:border-primary/50 focus:ring-2 focus:ring-primary/10 rounded-xl pl-4 pr-10 py-3 text-body-sm text-foreground placeholder:text-muted-foreground/50 outline-none transition-all duration-200"
 />
 <button
 type="button"
 ...
 <div className="space-y-2 mt-2 p-3 bg-[hsl(var(--foreground)/0.01)] border-border/50 rounded-xl animate-fade-in text-left">
 ...
 className="bg-[hsl(var(--state-error-text))]/10 hover:bg-[hsl(var(--state-error-text))]/20 text-[hsl(var(--state-error-text))] border-[hsl(var(--state-error-text))]/20 text-xs px-3 rounded-full"
 >
 ...
 <div className="divide-y divide-border/60 border-border/60 rounded-xl overflow-hidden bg-[hsl(var(--foreground)/0.01)]">
 ...
 <div className="p-2 bg-[hsl(var(--foreground)/0.02)] border-border/50 rounded-xl text-muted-foreground shrink-0">
 ...
 {session.isCurrent && (
 <Badge className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 text-[9px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full">
 Current Session
 </Badge>
 )}
 </div>
 ...
 className="p-2 text-muted-foreground hover:text-[hsl(var(--state-error-text))] hover:bg-[hsl(var(--state-error-bg))] border-transparent rounded-full transition-all duration-200 cursor-pointer"
 >
 ...
 <div className="p-5 border-[hsl(var(--state-warning-text))]/20 bg-[hsl(var(--state-warning-bg))]/10 rounded-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
 <div>
 ...
 className="bg-[hsl(var(--state-warning-text))]/10 hover:bg-[hsl(var(--state-warning-text))]/20 text-[hsl(var(--state-warning-text))] border-[hsl(var(--state-warning-text))]/20 text-xs px-4 rounded-full"
 >
 Deactivate Profile
 </Button>
 </div>
 ...
 {/* Delete account card */}
 <div className="p-5 border-[hsl(var(--state-error-text))]/20 bg-[hsl(var(--state-error-bg))]/10 rounded-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
 <div>
 ...
 <div className="bg-popover border-border p-6 rounded-2xl w-full max-w-md shadow-2xl animate-scale-in text-left">
