...
export default function ContactPage() {
 ...
 {submitted ? (
 <div className="radius-xl border-primary/20 bg-primary/[0.03] p-space-10 text-center">
 ...
 <div className="radius-xl border-[hsl(var(--foreground)/0.06)] bg-[hsl(var(--foreground)/0.02)] p-space-7">
 ...
 <Input required className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors" placeholder="Rohan" />
 </div>
 <div>
 <label className="block text-caption text-muted-foreground mb-space-2">Last Name *</label>
 <Input required className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors" placeholder="Mehta" />
 </div>
 </div>
 <div>
 <label className="block text-caption text-muted-foreground mb-space-2">Business Email *</label>
 <Input required type="email" className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors" placeholder="rohan@clinic.com" />
 </div>
 <div>
 <label className="block text-caption text-muted-foreground mb-space-2">Company / Practice Name</label>
 <Input className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors" placeholder="Bright Smile Dental" />
 </div>
 <div>
 <label className="block text-caption text-muted-foreground mb-space-2">Phone Number</label>
 <Input type="tel" className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors" placeholder="+91 98765 43210" />
 </div>
 {type === "sales" && (
 <div>
 <label className="block text-caption text-muted-foreground mb-space-2">How many locations?</label>
 <NativeSelect className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground focus:border-primary/40 focus:outline-none transition-colors">
 ...
 required
 rows={4}
 className="w-full radius-lg border-[hsl(var(--foreground)/0.08)] bg-background px-space-3 py-space-2 text-body-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/40 focus:outline-none transition-colors resize-none"
 ...
 {loading ? (
 <div className="h-4 w-4 radius-full border-primary-foreground/30 border-t-primary-foreground animate-spin" />
 ) : (
 <>
 ...
 {/* Response times */}
 <div className="radius-lg border-[hsl(var(--foreground)/0.06)] bg-[hsl(var(--foreground)/0.02)] p-space-6">
