...
export function RulesSettingsClient({ initialRules }: RulesSettingsClientProps) {
 ...
 {/* Triggers Card */}
 <div className="border-border-default radius-lg bg-bg-layer-1 p-space-6 space-y-space-5">
 <div>
 ...
 {/* Toggle 1 */}
 <div
 className="flex items-start justify-between p-space-4 radius-lg border-border-subtle bg-bg-layer-2 hover:border-border-default transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/20"
 ...
 <div
 className={cn(
 "relative inline-flex h-6 w-11 shrink-0 rounded-full border-transparent transition-colors duration-200 ease-in-out mt-space-1 pointer-events-none",
...
- Any mention of insurance authorization problems"
 ...
 className="w-full text-body-sm min-h-60 p-space-4 radius-lg border-border-default bg-bg-layer-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary placeholder:text-muted-foreground transition-all duration-200 resize-y"
 />
 ...
 <div className="p-space-4 radius-lg bg-[hsl(var(--foreground)/0.03)] border-border-subtle flex gap-space-3 items-start">
